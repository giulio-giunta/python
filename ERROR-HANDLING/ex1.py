...
# type of arguments to the function, it should return the string "Please provide two integers or 
# floats". If you pass as the second argument a 0, Python will raise a ZeroDivisionError, so if 
# this function is invoked with a 0 as the value of num2, return the string "Please do not divide by zero"
